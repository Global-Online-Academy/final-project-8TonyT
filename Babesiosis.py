...
with open(file_path, 'r') as file:
    ...
    for row in csv_reader:
        ...
        if "Babesiosis" in row[0] and "California" in row[1] and "Total" in row[3]:
            y_values.append(str(row[4]))  # Convert to float if the values are numeric

# Output to a standalone HTML file
output_file("Cases of Babesiosis during 2001-2014 in California.html")
years = ["2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014"]
# Create a new plot with a title and axis labels
p = figure(x_range=years, height=350, title="Cases of Babesiosis during 2001-2014 in California", 
